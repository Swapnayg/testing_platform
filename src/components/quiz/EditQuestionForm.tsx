...
const EditQuestionForm = ({ question, onSubmit, onCancel, marksPerQuestion }: EditQuestionFormProps) => {
  const [questionType, setQuestionType] = useState<Question['type']>(question.type);
  ...
  useEffect(() => {
    ...
    setTrueFalseAnswer(question.correctAnswer === 'false' ? 'false' : 'true');
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-slate-800">Edit Question</CardTitle>
      </CardHeader>
      <CardContent>
