...
const QuestionBuilder: React.FC<QuestionBuilderProps> = ({ questionIndex, onRemove }) => {
  ...
  return (
    <Card className="w-full bg-slate-100 border-b border-slate-200 shadow-lg">
      <CardHeader className="bg-slate-700 hover:bg-slate-600 text-white rounded-t-lg p-6 flex flex-row items-center justify-between space-y-0 pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-gray-100 text-black-700 border border-black-300 rounded px-3 py-2 cursor-not-allowed`}
            />
            {questionError?.marks && (
